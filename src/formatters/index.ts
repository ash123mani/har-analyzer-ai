...
export function formatCli(metrics: MetricsResult, bottlenecks: Bottleneck[]): string {
  const lines: string[] = [];
...
export function formatJson(metrics: MetricsResult, bottlenecks: Bottleneck[]): string {
